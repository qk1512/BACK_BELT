...
/**
 * @brief Read full IMU data - accel + gyro (thread-safe)
 *
 ...
 * @param gx Pointer to store X gyro (rad/s) - can be NULL if not needed
 * @param gy Pointer to store Y gyro (rad/s) - can be NULL if not needed
 * @param gz Pointer to store Z gyro (rad/s) - can be NULL if not needed
 * @return 0 on success, negative error code on failure
 */
