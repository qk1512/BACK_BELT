...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_NORDIC_NRF21540_FEM_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SB_NUM_VER_COUNTER_SLOTS, 240);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MPSL_FEM_ANY_SUPPORT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MPSL_FEM_NRF21540_GPIO_SUPPORT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MPSL_FEM_NRF21540_GPIO_SPI_SUPPORT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MPSL_FEM_NCS_SUPPORTED_FEM_USED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MPSL_FEM_API_AVAILABLE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MPSL_FEM, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MPSL_FEM_NRF21540_GPIO, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MPSL_FEM_NRF21540_TX_GAIN_DB, 10);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MPSL_FEM_NRF21540_TX_GAIN_DB_POUTA, 20);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MPSL_FEM_NRF21540_TX_GAIN_DB_POUTB, 10);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MPSL_FEM_NRF21540_RX_GAIN_DB, 13);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MPSL_FEM_DEVICE_CONFIG_254, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MPSL_FEM_INIT_PRIORITY, 50);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_THINGY53_NRF5340_CPUNET, 1);
