...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOOT_SERIAL_CDC_ACM, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MCUBOOT_SERIAL_DIRECT_IMAGE_UPLOAD, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ENABLE_MGMT_PERUSER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOOT_MGMT_CUSTOM_STORAGE_ERASE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOOT_SERIAL_ENTRANCE_GPIO, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOOT_SERIAL_DETECT_DELAY, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOOT_SERIAL_IMG_GRP_SLOT_INFO, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_DEVICE_PID, 0x5300);
